myApp.controller('myNewsController2', function($scope){
          ...
          $scope.new1Background = 'background-image: url('+'../../images/atzori.png'+')';
          ...
          $scope.longText = 'Cagliari, 3 marzo 2015 - È stato assegnato a Maurizio Atzori(nella foto a destra), \
          					 ...
          					 un prestigioso Google Faculty Research Award, premio destinato a finanziare progetti di \
